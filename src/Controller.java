...
//	private ResourceBundle resources;
	...
	public void initialize() {
		...
		pane1.setStyle("-fx-background-image: url('cato.jpg')");
		pane2.setStyle("-fx-background-image: url('alfonsi.jpg')");
		pane3.setStyle("-fx-background-image: url('carlos3.jpg')");
		pane4.setStyle("-fx-background-image: url('pepking.jpg')");
